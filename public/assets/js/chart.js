$(function() {
	...
	gradient.addColorStop(1, '#f96768');
	new Chart(ctx3, {
		type: 'bar',
		data: {
			labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
	...
	new Chart(ctx4, {
		...
		data: {
			...
			datasets: [{
				label: '# of Votes',
				data: [14, 12, 34, 25, 24, 20],
				backgroundColor: ['#7167ff', '#f96768', '#5ed94c', '#45aaf2', '#c344ff', '#f7592d']
			}]
		},
		options: {
			maintainAspectRatio: false,
	...
	new Chart(ctx5, {
		...
		data: {
			...
			datasets: [{
				data: [14, 12, 34, 25, 24, 20],
				backgroundColor: [ '#f96768', '#5ed94c', '#45aaf2', '#c344ff', '#f7592d']
			}, {
	...
	gradient1.addColorStop(0, 'rgba(113, 103, 255, 0)');
	gradient1.addColorStop(1, 'rgba(113, 103, 255, .5)');
	var gradient2 = ctx3.createLinearGradient(0, 280, 0, 0);
	gradient2.addColorStop(0, 'rgba(249, 103, 104, 0)');
	gradient2.addColorStop(1, 'rgba(249, 103, 104, .5)');
	new Chart(ctx9, {
		type: 'line',
		data: {
			labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'July', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
